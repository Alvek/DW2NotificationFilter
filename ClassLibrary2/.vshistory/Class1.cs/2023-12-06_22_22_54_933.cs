...
namespace ClassLibrary2
{
    ...
    [HarmonyDebug]
    [HarmonyPatch(typeof(DistantWorlds2.ScaledRenderer))]
    [HarmonyPatch(nameof(DistantWorlds2.ScaledRenderer.MessageHoverStart))] // if possible use nameof() here
    ...
    [HarmonyDebug]
    [HarmonyPatch(typeof(DistantWorlds2.ScaledRenderer))]
    [HarmonyPatch(nameof(DistantWorlds2.ScaledRenderer.MessageHoverEnd))] // if possible use nameof() here
    [HarmonyPatch(new Type[] { typeof(EmpireMessage) })]
