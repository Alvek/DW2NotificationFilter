...
namespace ClassLibrary2
{
    ...
    public class NotificationFilterPatcher
    {
        ...
        public static void ShowButton()
        {
            ...
            //    UserInterfaceController.EmpireMessageDialog.Position.Y + UserInterfaceController.EmpireMessageDialog.Size.Y);
            _dwButton.TargetPosition = new Stride.Core.Mathematics.Vector2 (UserInterfaceController.EmpireMessageDialog.Position.X, 
                UserInterfaceController.EmpireMessageDialog.TargetPosition.Y + UserInterfaceController.EmpireMessageDialog.TargetSize.Y);
