...
namespace ClassLibrary2
{
    ...
    [HarmonyPatch(new Type[] { typeof(EmpireMessage)})]
    ...
    [HarmonyPatch(new Type[] { typeof(EmpireMessage), typeof(bool), typeof(EmpireMessageDialog.ClickedEventHandler),
     ...
     DWButtonData yesButtonData, DWButtonData noButtonData, DWButtonData showButtonData, DWButtonData closeButtonData, RectangleF parentControlRectangle, Side relationToParent, float width, bool lockedOpen, EmpireMessageDialog.MessageHoveredEventHandler messageHoverStartEventHandler, EmpireMessageDialog.MessageHoveredEventHandler messageHoverEndEventHandler
