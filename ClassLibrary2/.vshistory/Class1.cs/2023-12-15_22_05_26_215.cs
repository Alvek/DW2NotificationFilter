...
namespace ClassLibrary2
{
    ...
    public class NotificationFilterPatcher
    {
        ...
        public static ScaledRenderer _ScaledRenderer;
        ...
        static NotificationFilterPatcher()
        {
            ...
            _dwButton.ClickEvent += CreateFilterRule;
        }
            ...
            if (__result)
            {
                ...
                if (!res)
                {
                    ...
                    if (activatedRule.DefaultAction == DefaultMessageAction.Yes)
                    {
                        ...
                        _ScaledRenderer.EmpireMessageYesClick(null, new DWEventArgs(__instance));
                    }
                    else if (activatedRule.DefaultAction == DefaultMessageAction.No)
                    { _ScaledRenderer.EmpireMessageNoClick(null, new DWEventArgs(__instance)); }
                    else if (activatedRule.DefaultAction == DefaultMessageAction.Show)
                    { _ScaledRenderer.EmpireMessageShowClick(null, new DWEventArgs(__instance)); }
                }
            }
        }
    ...
    public class DWGamePatcher
    {
        ...
        {
            NotificationFilterPatcher._ScaledRenderer = ____Renderer;
        }
    }
}