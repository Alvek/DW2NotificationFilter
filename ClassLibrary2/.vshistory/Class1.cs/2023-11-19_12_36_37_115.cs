...
namespace ClassLibrary2
{
    ...
    public class Class2
    {
        ...
        static Class2()
        {
            ...
            panel.RelationToParent = Side.Undefined;
            panel.Size = new Stride.Core.Mathematics.Vector2(100, 100);
            panel.TargetSize = new Stride.Core.Mathematics.Vector2(100, 100);
